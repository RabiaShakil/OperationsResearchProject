...
prob = LpProblem("Prob_3.2b", LpMaximize)
...
#         Additional constraints (b-part)
prob += x2 - x3 - x4 == 0, "Washer=dryer_constraint"
prob += x3 - x4 <= 100 , "E.Dryers_G.Dryers_constraint"
prob += -x3 + x4 <= 100, "G.Dryers_E.Dryers_constraint"
